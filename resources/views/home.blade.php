...
<a href="/create"> create projects </a> <br>
<a href="/displayprojects"> Display Projects </a> <br>
  ...
  <section class="section main-banner" id="top" data-section="section1">
    ...
    <div class="video-overlay header-text">
      <div class="caption">
        ...
        <h2>welcome <em>{{Auth::user()->name}}</h2>
        <div class="main-button">
          <div class="scroll-to-section"><a href="/displayprojects" class="external">View Project List</a></div>
        </div>
      </div>
    </div>
  </section>
